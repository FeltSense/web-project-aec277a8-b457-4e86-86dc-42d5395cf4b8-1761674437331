export default function Footer() {
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="text-center mb-12 pb-12 border-b border-slate-700">
      ...
      <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
        <input
          ...
          className="flex-1 px-4 py-3 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-600"
        />
    ...
    <div className="grid md:grid-cols-4 gap-8 mb-8">
      {/* Company Info */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-4">Horizon Realty Group</h3>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Buy a Home</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Sell a Home</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Rent a Property</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Property Management</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Market Analysis</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Market Reports</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Buyer's Guide</a></li>
          <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Seller's Guide</a></li>
    ...
    <div className="border-t border-slate-700 pt-8 mt-8">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-gray-400 text-sm text-center md:text-left">
          &copy; 2025 Horizon Realty Group. All rights reserved.
        </p>
